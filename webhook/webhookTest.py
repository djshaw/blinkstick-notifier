...
class GetBlinkstickAlertForPrometheusTest( unittest.TestCase ):
    ...
    def testMultiSet( self ):
        ...
        self.assertEqual( "PersonalCalendarError", getBlinkstickAlertForPrometheusAlert( data["alerts"][0] ) )
        self.assertEqual( "DigitalEdCalendarError", getBlinkstickAlertForPrometheusAlert( data["alerts"][1] ) )
        self.assertEqual( "MaplesoftCalendarError", getBlinkstickAlertForPrometheusAlert( data["alerts"][2] ) )
